...
static struct l2_level l2_freq_tbl[] __initdata __initdata = {
	[0]  = { {  288000, PLL_8, 0, 2, 0x00 },  900000,  950000, 1 },
	[1]  = { {  384000, HFPLL, 2, 0, 0x20 },  950000, 1000000, 2 },
	...
	[6]  = { {  702000, HFPLL, 1, 0, 0x1A }, 1150000, 1150000, 4 },
...
static struct acpu_level acpu_freq_tbl_slow[] __initdata = {
	{ 1, {   288000, PLL_8, 0, 2, 0x00 }, L2(0),   850000 },
...
static struct acpu_level acpu_freq_tbl_nom[] __initdata = {
	{ 1, {   288000, PLL_8, 0, 2, 0x00 }, L2(0),   750000 },
	{ 0, {   384000, HFPLL, 2, 0, 0x20 }, L2(5),   850000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(5),   850000 },
	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(5),   925000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(5),   925000 },
	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(5),   937500 },
	{ 1, {   702000, HFPLL, 1, 0, 0x1A }, L2(5),   950000 },
	{ 0, {   756000, HFPLL, 1, 0, 0x1C }, L2(5),   950000 },
	{ 1, {   810000, HFPLL, 1, 0, 0x1E }, L2(5),   962500 },
	{ 0, {   864000, HFPLL, 1, 0, 0x20 }, L2(5),   962500 },
	{ 1, {   918000, HFPLL, 1, 0, 0x22 }, L2(5),   962500 },
	{ 0, {   972000, HFPLL, 1, 0, 0x24 }, L2(5),   975000 },
	{ 1, {  1026000, HFPLL, 1, 0, 0x26 }, L2(5),   975000 },
	{ 0, {  1080000, HFPLL, 1, 0, 0x28 }, L2(15),  987500 },
	{ 1, {  1134000, HFPLL, 1, 0, 0x2A }, L2(15),  987500 },
	{ 0, {  1188000, HFPLL, 1, 0, 0x2C }, L2(15), 1000000 },
	{ 1, {  1242000, HFPLL, 1, 0, 0x2E }, L2(15), 1000000 },
	{ 1, {  1296000, HFPLL, 1, 0, 0x30 }, L2(15), 1050000 },
	{ 1, {  1350000, HFPLL, 1, 0, 0x32 }, L2(15), 1067500 },
	{ 1, {  1404000, HFPLL, 1, 0, 0x34 }, L2(15), 1075000 },
	{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(15), 1087500 },
	{ 1, {  1512000, HFPLL, 1, 0, 0x38 }, L2(15), 1100000 },
    { 1, {  1566000, HFPLL, 1, 0, 0x3A }, L2(15), 1125000 },
    { 1, {  1620000, HFPLL, 1, 0, 0x3C }, L2(15), 1137500 },
    { 1, {  1674000, HFPLL, 1, 0, 0x3E }, L2(15), 1150000 },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_fast[] __initdata = {
	{ 1, {   288000, PLL_8, 0, 2, 0x00 }, L2(0),   725000 },
	{ 0, {   384000, HFPLL, 2, 0, 0x20 }, L2(5),   825000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(5),   875000 },
	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(5),   900000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(5),   900000 },
	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(5),   925000 },
	{ 1, {   702000, HFPLL, 1, 0, 0x1A }, L2(5),   925000 },
	{ 0, {   756000, HFPLL, 1, 0, 0x1C }, L2(5),   937500 },
	{ 1, {   810000, HFPLL, 1, 0, 0x1E }, L2(5),   937500 },
	{ 0, {   864000, HFPLL, 1, 0, 0x20 }, L2(5),   950000 },
	{ 1, {   918000, HFPLL, 1, 0, 0x22 }, L2(5),   950000 },
	{ 0, {   972000, HFPLL, 1, 0, 0x24 }, L2(5),   962500 },
	{ 1, {  1026000, HFPLL, 1, 0, 0x26 }, L2(5),   962500 },
	{ 0, {  1080000, HFPLL, 1, 0, 0x28 }, L2(15),  975000 },
	{ 1, {  1134000, HFPLL, 1, 0, 0x2A }, L2(15),  975000 },
	{ 0, {  1188000, HFPLL, 1, 0, 0x2C }, L2(15),  987500 },
	{ 1, {  1242000, HFPLL, 1, 0, 0x2E }, L2(15),  987500 },
	{ 1, {  1296000, HFPLL, 1, 0, 0x30 }, L2(15), 1025000 },
	{ 1, {  1350000, HFPLL, 1, 0, 0x32 }, L2(15), 1035000 },
	{ 1, {  1404000, HFPLL, 1, 0, 0x34 }, L2(15), 1037500 },
	{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(15), 1040000 },
	{ 1, {  1512000, HFPLL, 1, 0, 0x38 }, L2(15), 1050000 },
    { 1, {  1566000, HFPLL, 1, 0, 0x3A }, L2(15), 1067500 },
    { 1, {  1620000, HFPLL, 1, 0, 0x3C }, L2(15), 1075000 },
    { 1, {  1674000, HFPLL, 1, 0, 0x3E }, L2(15), 1100000 },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_faster[] __initdata = {
	{ 1, {   288000, PLL_8, 0, 2, 0x00 }, L2(0),   712500 },
	{ 0, {   384000, HFPLL, 2, 0, 0x20 }, L2(5),   800000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(5),   850000 },
	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(5),   887500 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(5),   887500 },
	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(5),   912500 },
	{ 1, {   702000, HFPLL, 1, 0, 0x1A }, L2(5),   912500 },
	{ 0, {   756000, HFPLL, 1, 0, 0x1C }, L2(5),   925000 },
	{ 1, {   810000, HFPLL, 1, 0, 0x1E }, L2(5),   925000 },
	{ 0, {   864000, HFPLL, 1, 0, 0x20 }, L2(5),   937500 },
	{ 1, {   918000, HFPLL, 1, 0, 0x22 }, L2(5),   937500 },
	{ 0, {   972000, HFPLL, 1, 0, 0x24 }, L2(5),   950000 },
	{ 1, {  1026000, HFPLL, 1, 0, 0x26 }, L2(5),   950000 },
	{ 0, {  1080000, HFPLL, 1, 0, 0x28 }, L2(15),  962500 },
	{ 1, {  1134000, HFPLL, 1, 0, 0x2A }, L2(15),  962500 },
	{ 0, {  1188000, HFPLL, 1, 0, 0x2C }, L2(15),  975000 },
	{ 1, {  1242000, HFPLL, 1, 0, 0x2E }, L2(15),  975000 },
	{ 1, {  1296000, HFPLL, 1, 0, 0x30 }, L2(15), 1000000 },
	{ 1, {  1350000, HFPLL, 1, 0, 0x32 }, L2(15), 1005500 },
	{ 1, {  1404000, HFPLL, 1, 0, 0x34 }, L2(15), 1012500 },
	{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(15), 1020000 },
	{ 1, {  1512000, HFPLL, 1, 0, 0x38 }, L2(15), 1025000 },
    { 1, {  1566000, HFPLL, 1, 0, 0x3A }, L2(15), 1050000 },
    { 1, {  1620000, HFPLL, 1, 0, 0x3C }, L2(15), 1067500 },
